...
const questionsNumber = parseInt(CryptoJS.AES.decrypt(localStorage.getItem('questionsNumber'), secretKey).toString(CryptoJS.enc.Utf8));
...
var correctPercent = (Math.floor(((score / questionsNumber) * 100) * 100) / 100);
console.log(correctPercent);
var wrongPercent = (100 - correctPercent);
console.log(wrongPercent);
var wrongTot = `${questionsNumber - score}/${questionsNumber}`;
var correctTot = `${score}/${questionsNumber}`;
